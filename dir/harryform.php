...
<?php
    ...
    if(!$conn){
        die("sorry we failed to connnet:".mysqli_connect_error());
    }
    else{
        echo "connection was succesful";
    }
    
    $sql = "INSERT INTO `conyash` (`name`, `email`, `concern`, `dt`) VALUES ('$name', '$email', '$desc', current_timestamp());";
    $result = mysqli_query($conn,$sql);
    if($result){
        echo "table has been created ";
    }
    else {
        echo "table already exits".mysqli_error($result);
    }
...
<h1>contact us for your concerns</h1>
    <form action="harryform.php" method="post">
  ...
  <?php 
  $conn11 = mysqli_connect("localhost","root","","dbyash");
  if(!$conn11){
